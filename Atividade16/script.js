function confirmarCurso() {
    ...
    var valor = curso.value;
  
    var cursoNome = curso.options[curso.selectedIndex].text;
    var confirmacao = confirm("Deseja abrir a página do curso " + cursoNome + "?");
      if (confirmacao) {
        abrirPaginaCurso(valor, cursoNome);
      }
  }
  ...
  function abrirPaginaCurso(curso, nome) {
    ...
    var url = ""; 
    var descricao = obterDescricao(curso);
    ...
    if (novaJanela) {
      ...
      alert("Não é possível abrir a janela.");
    }
  }
  
  function obterDescricao(curso) {
    var descricaoCursos = {
